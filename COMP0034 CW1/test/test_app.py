...
def test_cycle013_daydropdownchangesdropdown(dash_duo, app):
    ...
    .
    """
    #dash_duo.wait_for_element("#monthly-avgusage-graph .gtitle", timeout=9)
    # select_input = dash_duo.find_element("#day-dropdown input")
    # select_input.send_keys("Sunday, Jul 1 2018.xlsx")
    # select_input.send_keys(Keys.RETURN)
    dash_duo.driver.implicitly_wait(10)
...
#     x_axis = dash_duo.find_element("#daily-usage-graph .x-axis-title")
...
#     # select_input.send_keys(Keys.RETURN)
#     dash_duo.driver.implicitly_wait(10)
#     y_axis = dash_duo.find_element("#daily-usage-graph .y-axis-title")
...
#     # select_input.send_keys(Keys.RETURN)
#     dash_duo.driver.implicitly_wait(10)
#     y_axis = dash_duo.find_element("#monthly-avgusage-graph .y-axis-title")
...
#     # select_input.send_keys(Keys.RETURN)
#     dash_duo.driver.implicitly_wait(10)
#     x_axis = dash_duo.find_element("#monthly-totusage-graph .x-axis-title")
...
#     # select_input.send_keys(Keys.RETURN)
#     dash_duo.driver.implicitly_wait(10)
#     y_axis = dash_duo.find_element("#monthly-totusage-graph .y-axis-title")
...
#     # select_input.send_keys(Keys.RETURN)
#     dash_duo.driver.implicitly_wait(10)
#     x_axis = dash_duo.find_element("#pollution-bar-graph .x-axis-title")
...
#     # select_input.send_keys(Keys.RETURN)
#     dash_duo.driver.implicitly_wait(10)
#     y_axis = dash_duo.find_element("#pollution-bar-graph .y-axis-title")
